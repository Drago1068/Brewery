...
JOURNAL_SCHEMA_VERSION = "phase4-journal-v1"

# §26 closed event vocabulary (exact list from accepted Phase 4 specification).
JOURNAL_EVENT_TYPES = frozenset(
    {
        "FERMENTATION_SESSION_STARTED",
        "FERMENTATION_STAGE_ENTERED",
        "FERMENTATION_STAGE_PAUSED",
        "FERMENTATION_STAGE_RESUMED",
        ...
        "FERMENTATION_REMINDER_EXPIRED",
        "FERMENTATION_ACTION_RECORDED",
        "FERMENTATION_ACTION_CORRECTED",
        ...
        "YEAST_REFERENCE_CORRECTED",
        "OG_CONSUMPTION_PINNED",
        "OG_CONSUMPTION_RECONCILED",
