...
ACTION_SCHEMA_VERSION = "phase4-action-v1"
ADDITION_SCHEDULE_SCHEMA_VERSION = "phase4-addition-schedule-v1"
ADDITION_CORRECTION_SCHEMA_VERSION = "phase4-addition-correction-v1"
...
ADDITION_TIMING_BASES = frozenset({"FROM_PITCH", "AT_FERMENTATION_START"})
ADDITION_RUNTIME_OCCURRENCE_POLICY = "DO_NOT_COPY"
